...
// This is the main file for the demo bot.
...
controller.ready(() => {
  ...
  controller.hears("hello", "message", async (bot, message) => {
    await bot.reply(message, "Hello How Are You?");
  });

  controller.hears("hii", "message", async (bot, message) => {
    await bot.reply(message, "Hi there!");
  });

  controller.hears("option2", "message", async (bot, message) => {
    await bot.reply(
      message,
      `<html>
<body>
...
<iframe width="420" height="345" src="https://www.youtube.com/embed/tgbNymZ7vqY">
  ...
  controller.hears("option1", "message", async (bot, message) => {
    // do something!
    await bot.reply(
      message,
      `<html>
...
<table>
  ...
  controller.hears("option3", "message", async (bot, message) => {
    // do something!
    await bot.reply(
      message,
      `<html>
